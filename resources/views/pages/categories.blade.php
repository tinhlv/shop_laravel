              ...
              <div class="row">
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-1.jpg') }}" alt="">
                      <h5 class="new">New</h5>
                    </div>
                    <div class="l_p_text">
                      <ul>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-2.jpg') }}" alt="">
                    </div>
                    <div class="l_p_text">
                      <ul>
                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-3.jpg') }}" alt="">
                      <h5 class="new">New</h5>
                    </div>
                    <div class="l_p_text">
                      <ul>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-4.jpg') }}" alt="">
                      <h5 class="new">New</h5>
                    </div>
                    <div class="l_p_text">
                      <ul>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-5.jpg') }}" alt="">
                    </div>
                    <div class="l_p_text">
                      <ul>
                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-6.jpg') }}" alt="">
                      <h5 class="new">New</h5>
                    </div>
                    <div class="l_p_text">
                      <ul>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-7.jpg') }}" alt="">
                      <h5 class="new">New</h5>
                    </div>
                    <div class="l_p_text">
                      <ul>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-8.jpg') }}" alt="">
                    </div>
                    <div class="l_p_text">
                      <ul>
                        <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="l_product_item">
                    <div class="l_p_img">
                      <img src="{{ asset('assets/img/product/c-product-9.jpg') }}" alt="">
