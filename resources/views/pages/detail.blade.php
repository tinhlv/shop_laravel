        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="l_product_item">
              <div class="l_p_img">
                <img class="img-fluid" src="{{ asset('assets/img/product/related-product/r-product-1.jpg') }}" alt="">
              </div>
              <div class="l_p_text">
                <ul>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="l_product_item">
              <div class="l_p_img">
                <img class="img-fluid" src="{{ asset('assets/img/product/related-product/r-product-2.jpg') }}" alt="">
                <h5 class="new">New</h5>
              </div>
              <div class="l_p_text">
                <ul>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="l_product_item">
              <div class="l_p_img">
                <img class="img-fluid" src="{{ asset('assets/img/product/related-product/r-product-3.jpg') }}" alt="">
              </div>
              <div class="l_p_text">
                <ul>
                  <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="l_product_item">
              <div class="l_p_img">
                <img class="img-fluid" src="{{ asset('assets/img/product/related-product/r-product-4.jpg') }}" alt="">
